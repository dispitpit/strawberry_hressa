...
# ====================== 使用者設定 ======================
CONCENTRATION = "npy"  # 對應 {CONCENTRATION}/healthy, {CONCENTRATION}/unhealthy
VI_CSV_PATH = Path(r"D:/Users/Amanda/PycharmProjects/test/test_0322_new.raw_pca(wait)/vi_40_output.csv")
