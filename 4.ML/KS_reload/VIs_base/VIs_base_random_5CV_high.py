'''
Train shape: (150, 39), Test shape: (50, 39)
Train label counts: {0: np.int64(75), 1: np.int64(75)}
Test  label counts: {0: np.int64(25), 1: np.int64(25)}
CV(5) Accuracy: 0.6667 ± 0.0632
...
# ====================== 設定 ======================
VI_CSV = Path(r"../../vi_40_high.csv")   # <-- 改成你的實際路徑
TRAIN_RATIO = 0.75
RANDOM_STATE = 42
np.random.seed(RANDOM_STATE)

OUT_CSV = Path("svm_vi_high.csv")  # 輸出結果表（選用）
