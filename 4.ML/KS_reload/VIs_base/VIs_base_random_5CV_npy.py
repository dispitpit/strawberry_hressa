'''
Train shape: (229, 39), Test shape: (76, 39)
Train label counts: {0: np.int64(77), 1: np.int64(152)}
Test  label counts: {0: np.int64(26), 1: np.int64(50)}
CV(5) Accuracy: 0.7291 ± 0.0367
...
# ====================== 設定 ======================
VI_CSV = Path(r"../../vi_40_output.csv")   # <-- 改成你的實際路徑
TRAIN_RATIO = 0.75
RANDOM_STATE = 42
np.random.seed(RANDOM_STATE)

OUT_CSV = Path("svm_vi_npy.csv")  # 輸出結果表（選用）
