...
# ====================== 設定 ======================
CONCENTRATION = "npy"  # 對應 {BASE_DIR}/{healthy,unhealthy}
...
'''
KS的依據: vi_40_output.csv -> ["MTCI", "VOG3", "VOG1", "Chlorophyll Index RedEdge", "CInir","TCARI/OSAVI","CIrededge","NDRE"]
'''
# ========================結果輸出==================
OUT_DIR = Path("ML_result/7_npy")
OUT_DIR.mkdir(parents=True, exist_ok=True)
RESULT_CSV = OUT_DIR / f"ml_ks_cv_{CONCENTRATION}.csv"
...
def main():
    ...
    # 保存模型
    dump(models["SVM (RBF)"], "best_model.joblib")
